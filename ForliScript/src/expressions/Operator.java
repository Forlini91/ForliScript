...
public enum Operator implements Token {
	...
	/** Priority */ 		public final int priority;
	/** Operator code */	public final UnaryOperation unaryOp;
	/** Operator code */	public final BinaryOperation binaryOp;
	...
	public static Operator parse(String text, int from, int to){
		if (from+1 < to){
			switch(text.substring(from, from+2)){
				case "==": return equalTo;
				case "!=": return differentThan;
				case "<=": return lessEqualsThan;
				case ">=": return greaterEqualsThan;
				case "&&": return and;
				case "||": return or;
				case "+=": return sumAndAssign;
				case "-=": return diffAndAssign;
				case "*=": return multAndAssign;
				case "/=": return divAndAssign;
				case "%=": return modAndAssign;
				case "^=": return powerAndAssign;
				case "#?": return isNumber;
		...
		switch(text.charAt(from)){
			...
			case '!': return not;
			case '?': return isSet;
			case '#': return toNumber;
			case '$': return toString;
			case '£': return toArray;
			case '=': return assign;
			case '[': return elementAt;
		}
		return null;
	}
